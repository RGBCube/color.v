	...
	#define V_COMMIT_HASH "360457e"
#endif

#ifndef V_CURRENT_COMMIT_HASH
	#define V_CURRENT_COMMIT_HASH "6b0743b"
#endif
...
typedef struct color__Color color__Color;
typedef struct _option_color__Color _option_color__Color;
...
typedef struct color__Brush color__Brush;
typedef struct color__BrushParams color__BrushParams;
typedef struct color__TrueColor color__TrueColor;
...
typedef struct _result_color__Brush _result_color__Brush;
typedef struct _result_color__Color _result_color__Color;
...
typedef enum {
	color__BasicColor__black, // 
	color__BasicColor__red, // +1
	color__BasicColor__green, // +2
	color__BasicColor__yellow, // +3
	color__BasicColor__blue, // +4
	color__BasicColor__magenta, // +5
	color__BasicColor__cyan, // +6
	color__BasicColor__white, // +7
	color__BasicColor__bright_black, // +8
	color__BasicColor__bright_red, // +9
	color__BasicColor__bright_green, // +10
	color__BasicColor__bright_yellow, // +11
	color__BasicColor__bright_blue, // +12
	color__BasicColor__bright_magenta, // +13
	color__BasicColor__bright_cyan, // +14
	color__BasicColor__bright_white, // +15
}  color__BasicColor;
typedef enum {
	color__Style__reset, // 
	color__Style__bold, // +1
	color__Style__dim, // +2
	color__Style__italic, // +3
	color__Style__underline, // +4
	color__Style__slow_blink, // +5
	color__Style__rapid_blink, // +6
	color__Style__inverse, // +7
	color__Style__hidden, // +8
	color__Style__strikethrough, // +9
}  color__Style;
...
typedef array Array_color__Style;
typedef map Map_color__Style_int;
...
// Union sum type color__Color = 
//          |  109 = color__BasicColor   
//          |  110 = color__TrueColor    
struct color__Color {
	union {
		color__BasicColor* _color__BasicColor;
		color__TrueColor* _color__TrueColor;
	};
	int _typ;
};
...
struct _option_color__Color {
	byte state;
	IError err;
	byte data[sizeof(color__Color) > 1 ? sizeof(color__Color) : 1];
};

struct color__Brush {
	_option_color__Color fg;
	_option_color__Color bg;
	Array_color__Style style;
	bool disabled;
};



struct color__BrushParams {
	_option_color__Color fg;
	_option_color__Color bg;
	Array_color__Style style;
	bool disabled;
...
struct _result_color__Brush {
	bool is_error;
	IError err;
	byte data[sizeof(color__Brush) > 1 ? sizeof(color__Brush) : 1];
};

struct _result_color__Color {
	bool is_error;
	IError err;
	byte data[sizeof(color__Color) > 1 ? sizeof(color__Color) : 1];
};
...
VV_LOCAL_SYMBOL  int compare_9438354823030301259_RepIndex_by_idx(RepIndex* a, RepIndex* b) {
...
VV_LOCAL_SYMBOL  int compare_995642571747756660_string(string* a, string* b) {
...
VV_LOCAL_SYMBOL string color__BasicColor_render(color__BasicColor c, string msg);
VV_LOCAL_SYMBOL string color__BasicColor_render_bg(color__BasicColor c, string msg);
string color__Color_render(color__Color c, string msg);
string color__Color_render_bg(color__Color c, string msg);
void color__Color_cprint(color__Color c, string msg);
void color__Color_cprintln(color__Color c, string msg);
void color__Color_cprint_bg(color__Color c, string msg);
void color__Color_cprintln_bg(color__Color c, string msg);
_result_color__Brush color__new_brush(color__BrushParams p);
string color__Brush_render(color__Brush* p, string msg);
void color__Brush_cprint(color__Brush* p, string msg);
void color__Brush_cprintln(color__Brush* p, string msg);
string color__Style_render(color__Style s, string msg);
void color__Style_cprint(color__Style s, string msg);
void color__Style_cprintln(color__Style s, string msg);
_result_color__Color color__rgb(int r, int g, int b);
_result_color__Color color__hex(int hex);
VV_LOCAL_SYMBOL string color__TrueColor_render(color__TrueColor c, string msg);
VV_LOCAL_SYMBOL string color__TrueColor_render_bg(color__TrueColor c, string msg);
...
color__Color _const_color__black; // inited later
color__Color _const_color__red; // inited later
color__Color _const_color__green; // inited later
color__Color _const_color__yellow; // inited later
color__Color _const_color__blue; // inited later
color__Color _const_color__magenta; // inited later
color__Color _const_color__cyan; // inited later
color__Color _const_color__white; // inited later
color__Color _const_color__bright_black; // inited later
color__Color _const_color__bright_red; // inited later
color__Color _const_color__bright_green; // inited later
color__Color _const_color__bright_yellow; // inited later
color__Color _const_color__bright_blue; // inited later
color__Color _const_color__bright_magenta; // inited later
color__Color _const_color__bright_cyan; // inited later
color__Color _const_color__bright_white; // inited later
color__Style _const_color__reset; // inited later
color__Style _const_color__bold; // inited later
color__Style _const_color__dim; // inited later
color__Style _const_color__italic; // inited later
color__Style _const_color__underline; // inited later
color__Style _const_color__slow_blink; // inited later
color__Style _const_color__rapid_blink; // inited later
color__Style _const_color__inverse; // inited later
color__Style _const_color__hidden; // inited later
color__Style _const_color__strikethrough; // inited later
bool _const_color__no_color; // inited later
...
// V auto functions:
static inline color__Color color__BasicColor_to_sumtype_color__Color(color__BasicColor* x) {
	color__BasicColor* ptr = memdup(x, sizeof(color__BasicColor));
	return (color__Color){ ._color__BasicColor = ptr, ._typ = 109};
}

static inline color__Color color__TrueColor_to_sumtype_color__Color(color__TrueColor* x) {
	color__TrueColor* ptr = memdup(x, sizeof(color__TrueColor));
	return (color__Color){ ._color__TrueColor = ptr, ._typ = 110};
}
...
static int v_typeof_interface_idx_IError(int sidx) { /* IError */ 
	...
	if (sidx == _IError_os__Eof_index) return 126;
	if (sidx == _IError_os__NotExpected_index) return 127;
	if (sidx == _IError_os__FileNotOpenedError_index) return 65666;
	if (sidx == _IError_os__SizeOfTypeIs0Error_index) return 65667;
	if (sidx == _IError_os__ExecutableNotFoundError_index) return 65681;
	return 29;
}
char * v_typeof_sumtype_color__Color(int sidx) { /* color.Color */ 
	switch(sidx) {
		case 111: return "color.Color";
		case 109: return "color.BasicColor";
		case 110: return "color.TrueColor";
		default: return "unknown color.Color";
	}
}

int v_typeof_sumtype_idx_color__Color(int sidx) { /* color.Color */ 
	switch(sidx) {
		case 111: return 111;
		case 109: return 109;
		case 110: return 110;
...
string string_replace_each(string s, Array_string vals) {
	...
	qsort(idxs.data, idxs.len, idxs.element_size, (int (*)(const void *, const void *))&compare_9438354823030301259_RepIndex_by_idx);
	u8* b = malloc_noscan(new_len + 1);
	int idx_pos = 0;
...
string string_trim(string s, string cutset) {
	...
	multi_return_int_int mr_36099 = string_trim_indexes(s, cutset);
	int left = mr_36099.arg0;
	int right = mr_36099.arg1;
...
_result_Array_string os__glob(Array_string patterns) {
 ...
 ;
	...
	qsort(matches.data, matches.len, matches.element_size, (int (*)(const void *, const void *))&compare_995642571747756660_string);
...
VV_LOCAL_SYMBOL string color__BasicColor_render(color__BasicColor c, string msg) {
	term__black _t1 = 0;
	switch (c) {
		case color__BasicColor__black: {
				_t1 = term__black;
				break;
		}
		case color__BasicColor__red: {
				_t1 = term__red;
				break;
		}
		case color__BasicColor__green: {
				_t1 = term__green;
				break;
		}
		case color__BasicColor__yellow: {
				_t1 = term__yellow;
				break;
		}
		case color__BasicColor__blue: {
				_t1 = term__blue;
				break;
		}
		case color__BasicColor__magenta: {
				_t1 = term__magenta;
				break;
		}
		case color__BasicColor__cyan: {
				_t1 = term__cyan;
				break;
		}
		case color__BasicColor__white: {
				_t1 = term__white;
				break;
		}
		case color__BasicColor__bright_black: {
				_t1 = term__bright_black;
				break;
		}
		case color__BasicColor__bright_red: {
				_t1 = term__bright_red;
				break;
		}
		case color__BasicColor__bright_green: {
				_t1 = term__bright_green;
				break;
		}
		case color__BasicColor__bright_yellow: {
				_t1 = term__bright_yellow;
				break;
		}
		case color__BasicColor__bright_blue: {
				_t1 = term__bright_blue;
				break;
		}
		case color__BasicColor__bright_magenta: {
				_t1 = term__bright_magenta;
				break;
		}
		case color__BasicColor__bright_cyan: {
				_t1 = term__bright_cyan;
				break;
		}
		case color__BasicColor__bright_white: {
				_t1 = term__bright_white;
				break;
		}
	}
	string (*func) (string msg) = _t1;
	string _t2 = func(msg);
	return _t2;
}
...
VV_LOCAL_SYMBOL string color__BasicColor_render_bg(color__BasicColor c, string msg) {
	...
	switch (c) {
		...
		case color__BasicColor__bright_black: {
				_t1 = term__bright_bg_black;
				break;
		}
		case color__BasicColor__bright_red: {
				_t1 = term__bright_bg_red;
				break;
		}
		case color__BasicColor__bright_green: {
				_t1 = term__bright_bg_green;
				break;
		}
		case color__BasicColor__bright_yellow: {
				_t1 = term__bright_bg_yellow;
				break;
		}
		case color__BasicColor__bright_blue: {
				_t1 = term__bright_bg_blue;
				break;
		}
		case color__BasicColor__bright_magenta: {
				_t1 = term__bright_bg_magenta;
				break;
		}
		case color__BasicColor__bright_cyan: {
				_t1 = term__bright_bg_cyan;
				break;
		}
		case color__BasicColor__bright_white: {
				_t1 = term__bright_bg_white;
				break;
		}
	}
	string (*func) (string msg) = _t1;
...
// TypeDecl
string color__Color_render(color__Color c, string msg) {
	if (_const_color__no_color) {
		return msg;
	}
	string _t2 = color__Color_render(c, msg);
	return _t2;
}
...
string color__Color_render_bg(color__Color c, string msg) {
	...
	string _t2 = color__Color_render_bg(c, msg);
	return _t2;
}

void color__Color_cprint(color__Color c, string msg) {
	print(color__Color_render(c, msg));
}

void color__Color_cprintln(color__Color c, string msg) {
	println(color__Color_render(c, msg));
}

void color__Color_cprint_bg(color__Color c, string msg) {
	print(color__Color_render_bg(c, msg));
}

void color__Color_cprintln_bg(color__Color c, string msg) {
	println(color__Color_render_bg(c, msg));
}

_result_color__Brush color__new_brush(color__BrushParams p) {
	Map_color__Style_int count = new_map_noscan_key_value(sizeof(color__Style), sizeof(int), &map_hash_int_4, &map_eq_int_4, &map_clone_int_4, &map_free_nop)
	;
	for (int _t1 = 0; _t1 < p.style.len; ++_t1) {
		color__Style style = ((color__Style*)p.style.data)[_t1];
		(*(int*)map_get_and_set((map*)&count, &(color__Style[]){style}, &(int[]){ 0 }))++;
		if ((*(int*)map_get(ADDR(map, count), &(color__Style[]){style}, &(int[]){ 0 })) > 1) {
			return (_result_color__Brush){ .is_error=true, .err=_v_error(_SLIT("Multiple of the same style was provided")), .data={EMPTY_STRUCT_INITIALIZATION} };
		}
	}
	_result_color__Brush _t3;
	_result_ok(&(color__Brush[]) { ((color__Brush){.fg = p.fg,.bg = p.bg,.style = p.style,.disabled = 0,}) }, (_result*)(&_t3), sizeof(color__Brush));
	return _t3;
}

string color__Brush_render(color__Brush* p, string msg) {
	if (_const_color__no_color || p->disabled) {
		return msg;
	}
	string result = msg;
	_option_color__Color _t2;
	if (_t2 = p->fg, _t2.state == 0) {
		color__Color fg = *(color__Color*)_t2.data;
		result = color__Color_render(fg, result);
	}
	_option_color__Color _t3;
	if (_t3 = p->bg, _t3.state == 0) {
		color__Color bg = *(color__Color*)_t3.data;
		result = color__Color_render(bg, result);
	}
	for (int _t4 = 0; _t4 < p->style.len; ++_t4) {
		color__Style style = ((color__Style*)p->style.data)[_t4];
		result = color__Style_render(style, result);
	}
	return result;
}

void color__Brush_cprint(color__Brush* p, string msg) {
	print(color__Brush_render(p, msg));
}

void color__Brush_cprintln(color__Brush* p, string msg) {
	println(color__Brush_render(p, msg));
}
...
string color__Style_render(color__Style s, string msg) {
	...
	term__reset _t2 = 0;
	switch (s) {
		case color__Style__reset: {
				_t2 = term__reset;
				break;
		}
		case color__Style__bold: {
				_t2 = term__bold;
				break;
		}
		case color__Style__dim: {
				_t2 = term__dim;
				break;
		}
		case color__Style__italic: {
				_t2 = term__italic;
				break;
		}
		case color__Style__underline: {
				_t2 = term__underline;
				break;
		}
		case color__Style__slow_blink: {
				_t2 = term__slow_blink;
				break;
		}
		case color__Style__rapid_blink: {
				_t2 = term__rapid_blink;
				break;
		}
		case color__Style__inverse: {
				_t2 = term__inverse;
				break;
		}
		case color__Style__hidden: {
				_t2 = term__hidden;
				break;
		}
		case color__Style__strikethrough: {
				_t2 = term__strikethrough;
				break;
		}
	}
	string (*func) (string msg) = _t2;
	string _t3 = func(msg);
	return _t3;
}

void color__Style_cprint(color__Style s, string msg) {
	print(color__Style_render(s, msg));
}

void color__Style_cprintln(color__Style s, string msg) {
	println(color__Style_render(s, msg));
}

_result_color__Color color__rgb(int r, int g, int b) {
	if (r < 0 || r > 255 || g < 0 || g > 255 || b < 0 || b > 255) {
		return (_result_color__Color){ .is_error=true, .err=_v_error(_SLIT("Red, green and blue must each be between 0 and 255")), .data={EMPTY_STRUCT_INITIALIZATION} };
	}
	_result_color__Color _t2;
	_result_ok(&(color__Color[]) { color__TrueColor_to_sumtype_color__Color(ADDR(color__TrueColor, (((color__TrueColor){.r = r,.g = g,.b = b,})))) }, (_result*)(&_t2), sizeof(color__Color));
	return _t2;
}

_result_color__Color color__hex(int hex) {
	_result_color__Color _t2 = color__rgb(hex >> 16, (hex >> 8 & 0xFF), (hex & 0xFF));
	if (_t2.is_error) {
		_result_color__Color _t3;
		memcpy(&_t3, &_t2, sizeof(_result));
		return _t3;
	}
	
 	_result_color__Color _t1;
	_result_ok(&(color__Color[]) {  (*(color__Color*)_t2.data) }, (_result*)(&_t1), sizeof(color__Color));
	return _t1;
}

VV_LOCAL_SYMBOL string color__TrueColor_render(color__TrueColor c, string msg) {
	string _t1 = term__rgb(c.r, c.g, c.b, msg);
	return _t1;
}

VV_LOCAL_SYMBOL string color__TrueColor_render_bg(color__TrueColor c, string msg) {
	string _t1 = term__bg_rgb(c.r, c.g, c.b, msg);
	return _t1;
}

VV_LOCAL_SYMBOL void main__main(void) {
	color__Color_cprintln(_const_color__red, _SLIT("Hello World"));
	color__Color_cprintln_bg(_const_color__cyan, _SLIT("Hello World"));
	color__Style_cprintln(_const_color__bold, _SLIT("Hello World"));
	_result_color__Color _t3 = color__rgb(0, 0, 0);
	if (_t3.is_error) {
		panic_result_not_set(IError_name_table[_t3.err._typ]._method_msg(_t3.err._object));
	}
	_result_color__Color _t5 = color__hex(0xffffff);
	if (_t5.is_error) {
		panic_result_not_set(IError_name_table[_t5.err._typ]._method_msg(_t5.err._object));
	}
	
 	_option_color__Color _t4;
	_option_ok(&(color__Color[]) {  (*(color__Color*)_t5.data) }, (_option*)(&_t4), sizeof(color__Color));
	_option_color__Color _t2;
	_option_ok(&(color__Color[]) {  (*(color__Color*)_t3.data) }, (_option*)(&_t2), sizeof(color__Color));
	_result_color__Brush _t1 = color__new_brush(((color__BrushParams){.fg = _t2,.bg = _t4,.style = new_array_from_c_array_noscan(3, 3, sizeof(color__Style), _MOV((color__Style[3]){_const_color__bold, _const_color__underline, _const_color__italic})),.disabled = 0,}));
	if (_t1.is_error) {
		panic_result_not_set(IError_name_table[_t1.err._typ]._method_msg(_t1.err._object));
	}
	
 	color__Brush brush =  (*(color__Brush*)_t1.data);
	color__Brush_cprintln(&brush, _SLIT("Hello World"));
}
...
void _vinit(int ___argc, voidptr ___argv) {
	...
	// Initializations for module color
	_const_color__black = color__BasicColor_to_sumtype_color__Color(ADDR(color__BasicColor, (color__BasicColor__black)));
	_const_color__red = color__BasicColor_to_sumtype_color__Color(ADDR(color__BasicColor, (color__BasicColor__red)));
	_const_color__green = color__BasicColor_to_sumtype_color__Color(ADDR(color__BasicColor, (color__BasicColor__green)));
	_const_color__yellow = color__BasicColor_to_sumtype_color__Color(ADDR(color__BasicColor, (color__BasicColor__yellow)));
	_const_color__blue = color__BasicColor_to_sumtype_color__Color(ADDR(color__BasicColor, (color__BasicColor__blue)));
	_const_color__magenta = color__BasicColor_to_sumtype_color__Color(ADDR(color__BasicColor, (color__BasicColor__magenta)));
	_const_color__cyan = color__BasicColor_to_sumtype_color__Color(ADDR(color__BasicColor, (color__BasicColor__cyan)));
	_const_color__white = color__BasicColor_to_sumtype_color__Color(ADDR(color__BasicColor, (color__BasicColor__white)));
	_const_color__bright_black = color__BasicColor_to_sumtype_color__Color(ADDR(color__BasicColor, (color__BasicColor__bright_black)));
	_const_color__bright_red = color__BasicColor_to_sumtype_color__Color(ADDR(color__BasicColor, (color__BasicColor__bright_red)));
	_const_color__bright_green = color__BasicColor_to_sumtype_color__Color(ADDR(color__BasicColor, (color__BasicColor__bright_green)));
	_const_color__bright_yellow = color__BasicColor_to_sumtype_color__Color(ADDR(color__BasicColor, (color__BasicColor__bright_yellow)));
	_const_color__bright_blue = color__BasicColor_to_sumtype_color__Color(ADDR(color__BasicColor, (color__BasicColor__bright_blue)));
	_const_color__bright_magenta = color__BasicColor_to_sumtype_color__Color(ADDR(color__BasicColor, (color__BasicColor__bright_magenta)));
	_const_color__bright_cyan = color__BasicColor_to_sumtype_color__Color(ADDR(color__BasicColor, (color__BasicColor__bright_cyan)));
	_const_color__bright_white = color__BasicColor_to_sumtype_color__Color(ADDR(color__BasicColor, (color__BasicColor__bright_white)));
	_const_color__reset = color__Style__reset;
	_const_color__bold = color__Style__bold;
	_const_color__dim = color__Style__dim;
	_const_color__italic = color__Style__italic;
	_const_color__underline = color__Style__underline;
	_const_color__slow_blink = color__Style__slow_blink;
	_const_color__rapid_blink = color__Style__rapid_blink;
	_const_color__inverse = color__Style__inverse;
	_const_color__hidden = color__Style__hidden;
	_const_color__strikethrough = color__Style__strikethrough;
	_const_color__no_color = !term__can_show_color_on_stdout();
}
void _vcleanup(void) {
}
